...
class laser_gcode(inkex.Effect):
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("",   "--laser-command",                   action="store", type="string",          dest="laser_command",                       default="M106P01",                      help="Laser gcode command")
        self.OptionParser.add_option("",   "--laser-off-command",               action="store", type="string",          dest="laser_off_command",                   default="M107P01",                         help="Laser gcode end command")       
